                ...
                <AnimatePresence>
                  {showSuggestions && suggestions.length > 0 && (
                    <motion.div
                      ...
                      exit={{ opacity: 0, y: -10 }}
                      className="dropdown-modern modern-scrollbar"
                    >
                      {suggestions.map((s, idx) => {
                        ...
                        return (
                          <button
                            ...
                            className={`w-full px-5 py-4 text-left transition-all flex justify-between items-center group border-b border-slate-800 last:border-0 ${isSelected ? 'bg-emerald-500/10' : 'hover:bg-white/[0.05]'}`}
                          >
                            <div>
                              <span className={`block text-sm font-bold transition-colors uppercase ${isSelected ? 'text-emerald-400' : 'text-white group-hover:text-emerald-400'}`}>
                                {s.symbol}
                              </span>
