            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="dropdown-modern modern-scrollbar min-w-[220px]"
                    >
                        {options.length > 5 && (
                            <div className="p-2 sticky top-0 bg-[#0b1220] z-10 border-b border-white/5">
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full bg-slate-950/50 border border-slate-800 rounded-lg py-1.5 pl-8 pr-3 text-xs focus:outline-none focus:ring-1 focus:ring-indigo-500/50 placeholder:text-slate-600"
                                        autoFocus
                                    />
                        ...
                        <div className="py-1">
                            {filteredOptions.length > 0 ? (
                                filteredOptions.map((option) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`w-full text-left px-4 py-2.5 text-sm transition-all hover:bg-white/[0.05] ${isSelected ? 'bg-indigo-500/10 text-indigo-400 font-bold' : 'text-slate-300'}`}
                                        >
                                            {option}
                                        </button>
                                    );
                                ...
                                <div className="px-4 py-4 text-xs text-slate-500 text-center italic">
                                    No matches found
                                </div>
                            )}
                        </div>
