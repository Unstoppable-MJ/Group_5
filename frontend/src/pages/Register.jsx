        ...
        <div className="h-screen flex items-center justify-center relative overflow-hidden bg-slate-950">
            ...
            >
                <div className="flex flex-col items-center mb-8">
                    ...
                    <p className="text-slate-400 mt-2 text-sm text-center">Join <span className="font-bold text-slate-300">ChatSense</span> and start managing your portfolio</p>
                </div>
                ...
                {success && (
                    ...
                    >
                        Account created successfully. Welcome to <span className="font-bold">ChatSense</span>. Redirecting...
                    </motion.div>
                )}
